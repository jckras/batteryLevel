...
class ExampleApiSetup {
  ...
  static func setUp(binaryMessenger: FlutterBinaryMessenger, api: ExampleApi?, messageChannelSuffix: String = "") {
    let channelSuffix = messageChannelSuffix.count > 0 ? ".\(messageChannelSuffix)" : ""
    let getBatteryLevelChannel = FlutterBasicMessageChannel(name: "dev.flutter.pigeon.com.example.batterylevel.ExampleApi.getBatteryLevel\(channelSuffix)", binaryMessenger: binaryMessenger, codec: codec)
    if let api = api {
