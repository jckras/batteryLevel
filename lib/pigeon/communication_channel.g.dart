...
class ExampleApi {
  ...
  ExampleApi({BinaryMessenger? binaryMessenger, String messageChannelSuffix = ''})
  ...
  Future<int> getBatteryLevel() async {
    final pigeonVar_channelName = 'dev.flutter.pigeon.com.example.batterylevel.ExampleApi.getBatteryLevel$pigeonVar_messageChannelSuffix';
